            ...
            <form method="POST" action="{{ route('monitoring.store') }}">
                ...
                <div class="form-row form-check"> 
                    <div class="form-group">
                        <label for="keg1">1. Apakah penanggung jawab pelayanan menetapkan standar dan indikator untuk menilai proses pelaksaaan pelayanan</label>
                ...
                <div class="form-row form-check"> 
                    <div class="form-group">
                        <label for="keg2">2. Apakah penanggung jawab pelayanan mengumpulkan data</label>
                        <label class="col-md-12"> 
                ...
                <div class="form-row form-check"> 
                    <div class="form-group">
                        <label for="keg3">3. Apakah penanggung jawab pelayanan melakukan investigasi kinerja (pengamatan) dan pelaksaan kegiatan atau proses yang dipilih</label>
                        <label class="col-md-12"> 
                ...
                <div class="form-row form-check"> 
                    <div class="form-group">
                        <label for="keg4">4. Apakah penanggung jawab pelayanan membandingkan data yang diperoleh dengan standar atau indikator (baik kualitatif atau kuantitatif) yang telah ditentukan</label>
                        <label class="col-md-12"> 
                ...
                <div class="form-row form-check"> 
                    <div class="form-group">
                        <label for="keg5">5. Apakah penanggung jawab pelayanan mengamati perubahan lingkungan</label>
                        <label class="col-md-12"> 
                ...
                <div class="form-row form-check"> 
                    <div class="form-group">
                        <label for="keg6">6. Apakah penanggung jawab pelayanan mengumpulkan data untuk pengkajian lingkungan tersebut terhadap kegiatan yang sedang dilaksanakan</label>
                        <label class="col-md-12"> 
                ...
                <div class="form-row form-check"> 
                    <div class="form-group">
                        <label for="keg7">7. Apakah penanggung jawab pelayanan melakukan pengolahan, analisis data yang diperoleh</label>
                        <label class="col-md-12"> 
                ...
                <div class="form-row form-check"> 
                    <div class="form-group">
                        <label for="keg8">8. Apakah penanggung jawab pelayanan membuat penilaian dan kesimpulan tentang proses pelaksanaan kegiatan</label>
                        <label class="col-md-12"> 
                ...
                <div class="form-row form-check"> 
                    <div class="form-group">
                        <label for="keg9">9. Apakah penanggung jawab pelayanan mencatat hasil analisi dan kesimpulan</label>
                        <label class="col-md-12"> 
                ...
                <div class="form-row form-check"> 
                    <div class="form-group">
                        <label for="keg10">10. Apakah penanggung jawab program merumuskan rekomendasi tindak lanjut</label>
                        <label class="col-md-12"> 
                ...
                <div class="form-row form-check"> 
                    <div class="form-group">
                        <label for="keg11">11. Apakah penanggung jawab pelayanan mengambil keputusan melakukan tindakan (termasuk koreksi dan penyesuaian kegiatan, maupun perencanaan ulang)</label>
                        <label class="col-md-12"> 
                ...
                <div class="form-row form-check"> 
                    <div class="form-group">
                        <label for="keg12">12. Apakah penanggung jawab pelayanan menyampaikan semua hasil monitoring, pengendalian dan tindak lanjut kepada pihak yang berkepentingan sebagai wujud akunbilitas dan proses pengambilan keputusan lebih lanjut</label>
                        <label class="col-md-12"> 
